...
namespace Ex04.Menus.Interfaces
{
    public class MenuItem
    {
        ...
        public MenuItem(MenuItem i_Parent, string i_Caption, object i_Identifier, List<IMenuOptionChosenEventHandler> i_Listeners)
        {
            r_Parent = i_Parent;
            r_Caption = i_Caption;
            r_Identifier = i_Identifier;
            r_Listeners = i_Listeners;
        ...
        {
            foreach (IMenuOptionChosenEventHandler listener in r_Listeners)
            {
                listener.HandleMenuOptionSelection(r_Identifier);                    
            }
        }
        ...
        {
            MenuItem newItem = new MenuItem(this, i_Caption, i_Identifier, r_Listeners);
